...
const ArafatCombo = ({university, stName, setStName}) => {
    return (
        <div>
            ...
            <button className="mt-4 px-4 py-2 bg-blue-500 text-white rounded mr-2" onClick={() => setStName("Apurba")}>Apurba</button>
            <button className="mt-4 px-4 py-2 bg-blue-500 text-white rounded" onClick={() => setStName("Arafat")}>Arafat Nor</button>
        </div>
    );
};
